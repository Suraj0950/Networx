...
function Post({id, author, comment, description, image, createdAt, like, }) {
      ...
      <div>
        ...
        <div className='w-full flex justify-between items-center p-[20px] border-b-1 border-gray-500'>
          <div className='flex items-center justify-center gap-[5px] text-[18px]'>
            <BiLike className='text-[#3bccf9] w-[22px] h-[22px] cursor-pointer'/><span>{like.length}</span></div>
        ...
        <div className='w-full flex items-center p-[20px] gap-[20px] '>
          <div>
            <BiLike className=' w-[22px] h-[22px] cursor-pointer'/><span>like</span>
          </div>
